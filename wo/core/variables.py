...
class WOVariables():
    ...
    if wo_platform_codename == 'trustu' or wo_platform_codename == 'xenial' or wo_platform_codename == 'bionic':
        wo_nginx_repo = ("deb http://openresty.org/package/ubuntu $(lsb_release -sc) main")
